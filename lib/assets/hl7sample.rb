...
module HL7Sample
    ...
    def get_message_rde()
        ...
        msg = msg + "PID|0001||99990010||児玉^義憲^^^^^L^I~コダマ^ヨシノリ^^^^^L^P||19791101|M|||^^^^1510071^JPN^H^東京都渋谷区本町三丁目１２番１号住友不動産西新宿ビル６号館||^PRN^PH^^^^^^^^^03-1234-5678||||||||||||||||||||||||||" + "\r"
        ...
        msg = msg + "PV1|0001|O|01^^^^^C||||||||||||||||||||||||||||||||||||||||||" + "\r"
        msg = msg + "ORC|NW|000000000001152||1|||||20161028130607|D100^電子^太郎^^^^^^^L^^^^^I||D100^電子^太郎^^^^^^^L^^^^^I|01^^^^^C||20161028083000||01^内科^HL70069^01^内科^99zzz|SHIENBU-PC2843^^99zzz|||メドレークリニック|^^^^^JPN^^東京都渋谷区本町x-y-z|^^^^^^^^^^^03-123-4567||||||O^外来患者オーダ^HL70482|" + "\r"
        ...
        msg = msg + "TQ1|1||12N13&1日2回 朝・夕食後&99zzz|||14^日分|2016102808|2016111000||||||" + "\r"
        msg = msg + "RXR|PO^口^HL70162|||||" + "\r"
        msg = msg + "ORC|NW|000000000001152||2|||||20161028130607|D100^電子^太郎^^^^^^^L^^^^^I||D100^電子^太郎^^^^^^^L^^^^^I|01^^^^^C||20161028083000||01^内科^HL70069^01^内科^99zzz|SHIENBU-PC2843^^99zzz|||メドレークリニック|^^^^^JPN^^東京都渋谷区本町x-y-z|^^^^^^^^^^^03-123-4567||||||O^外来患者オーダ^HL70482|" + "\r"
        ...
        msg = msg + "TQ1|1||11N1&1日1回 朝食後&99zzz|||14^日分|2016102808|2016111000||||||" + "\r"
        msg = msg + "RXR|PO^口^HL70162|||||" + "\r"
        msg = msg + "ORC|NW|000000000001152||3|||||20161028130607|D100^電子^太郎^^^^^^^L^^^^^I||D100^電子^太郎^^^^^^^L^^^^^I|01^^^^^C||20161028083000||01^内科^HL70069^01^内科^99zzz|SHIENBU-PC2843^^99zzz|||メドレークリニック|^^^^^JPN^^東京都渋谷区本町x-y-z|^^^^^^^^^^^03-123-4567||||||O^外来患者オーダ^HL70482|" + "\r"
